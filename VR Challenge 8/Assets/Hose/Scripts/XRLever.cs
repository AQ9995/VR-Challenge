...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRLever : XRGrabInteractable
    {
        ...
        void OnDrawGizmosSelected()
        {
            ...
            var angleMaxPoint = angleStartPoint + transform.TransformDirection(Quaternion.Euler( 0.0f, m_MaxAngle, 0.0f) * Vector3.up) * k_AngleLength;
            var angleMinPoint = angleStartPoint + transform.TransformDirection(Quaternion.Euler( 0.0f, m_MaxAngle, 0.0f) * Vector3.up) * k_AngleLength;
